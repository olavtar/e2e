...
var _ = Describe("Rhoda e2e Test", func() {
	...
	Context("Populate providers array, create secret", func() {
		It("Get list of providers from the vault, create secrets, populate array", func() {
			...
			for _, providerName := range providerNames {
				//	When("Creating secret for "+providerName, func() {
	...
	Context("Create Inventory", func() {
		It("Adding dbaas scheme to create an inventory", func() {
			//	When("Adding dbaas scheme to create an inventory", func() {
			...
			for _, value := range providers {
				//		When("Creating inventory for "+value.ProviderName, func() {
